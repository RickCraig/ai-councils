...
2. **Identify gaps**: any capability at level 0 is worth investigating, especially in Governance Foundations
...
1. **Pick 2-3 capabilities to focus on** for the next quarter.
