...
Most established AI Councils use a **layered role structure** rather than a flat committee. This pattern appears consistently across Microsoft, IBM, NCUA's data governance model, and Collibra's governance framework.
...
1. **Cross-functional representation**: The council should reflect the breadth of AI's impact
