...
The Foundation Pack covers the core artifacts for formally establishing an AI Council. These artifacts define **who** the council is, **what** it stands for, **how** it operates, and **where** decisions go when the council can't resolve them.
