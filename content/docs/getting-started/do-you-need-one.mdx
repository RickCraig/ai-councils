...
The key word is "current." In 2025 and beyond, the question is not whether your organization uses AI in production. It almost certainly does. Enterprise platforms like Microsoft 365, Salesforce, ServiceNow, and others ship AI features that are enabled by default, often without a procurement decision or an intake request. If you do not know what AI is active across your organization, that gap is itself the argument for governance.

Start by cataloging what you have. See [Governing What You Already Have](/docs/getting-started/governing-what-you-already-have) for a step-by-step guide. Organizations that complete this exercise frequently discover they have far more AI in production than they realized, and that the lightweight approach is no longer sufficient.
