...
The council needs an executive sponsor: a C-suite or senior leader who is accountable to the board and willing to allocate resources. See [Roles and Membership](/docs/foundation/roles-and-membership) for the full role definition.
