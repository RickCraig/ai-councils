...
description: The council's review instruments, including impact assessments, model cards, security review, red-teaming, and human oversight.
---

The Review & Assurance Pack provides the **instruments the council uses during structured reviews**. These are the artifacts that transform a committee discussion into an evidence-based decision.
